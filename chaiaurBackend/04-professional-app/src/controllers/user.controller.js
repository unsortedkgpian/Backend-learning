...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // check for images, check form avatar
  // upload to clodinary, avatar
  // create user object - create entry in db
  // remove password and referest token field from response
  ...
  // const coverImageLocalPath = req.files?.coverImage[0]?.path;
    ...
    if(req.file && Array.isArray(req.file.coverImage ) && req.files.coverImage.length>0){
